            ...
            <div  class=" xs:w-full mx-auto shadow-2xl p-4 rounded-xl h-fit self-center ">
                ...
                <div class="">
                    ...
                    <h2 class="text-grey text-sm mb-4 ">Create Profile</h2>
                    <form>
                        <!-- Cover Image -->
                        <div
                        ...
                        <h2 class="text-center mt-1 font-semibold 00">Upload Profile and Cover Image
                        </h2>
                        ...
                        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                            <div class="w-full mt-6">
                                ...
                                <select
                                        class="w-full text-grey border-2 rounded-lg p-4 pl-2 pr-2 ">
